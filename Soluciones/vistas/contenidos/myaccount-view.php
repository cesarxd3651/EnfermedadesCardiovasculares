<div class="container-fluid">
		...
		<!-- Panel mi cuenta -->
		<?php 
		// $datos para leer lo q viene en la URL
			...
			if(isset($datos[1]) && ($datos[1]=="admin" || $datos[1]=="user" )):
				...
				$filasC=$classCuenta->datos_cuenta_controlador($datos[2],$datos[1]);

				// PARA COMPROBAR Q LA CUENTA EXISTE
				if ($filasC->rowCount()==1) {
					//fetch para hacer arrays de datos de la bd, trae todo los datos de la bd
					$campos=$filasC->fetch();
				?>
					<div class="container-fluid">
						...
						<form action="<?php echo SERVERURL; ?>ajax/cuentaAjax.php" method="POST" data-form="update" class="FormularioAjax" autocomplete="off" enctype="multipart/form-data">
							<?php
							// comprobar que si es administrador principal, y que puede deditar cuenta, el admin con privilegio 3, no puedo editar.
								if ($_SESSION['codigo_cuenta_sbm']!= $campos['CuentaCodigo'] ) {
									if ($_SESSION['tipo_sbm']!="Administrador" || $_SESSION['privilegio_sbm']<1 || $_SESSION['privilegio_sbm'] > 2) {
							...
							?>
					    		...
					    		<div class="container-fluid">
					    			<div class="row">
					    				...
					    				<div class="col-xs-12 col-sm-6">
											<div class="form-group label-floating">
											  	...
											  	<input class="form-control" type="email" name="email-up" maxlength="50" value="<?php echo $campos['CuentaEmail']; ?>">
											</div>
					    				</div>
					    				<div class="col-xs-12 col-sm-6">
											<div class="form-group">
												...
												<div class="radio radio-primary">
													<label>
														<input type="radio" name="optionsGenero-up" <?php if ($campos['CuentaGenero']=="Masculino") {
															echo 'checked=""';
														}   ?> value="Masculino" >
												...
												<div class="radio radio-primary">
													<label>
														<input type="radio" name="optionsGenero-up" <?php if ($campos['CuentaGenero']=="Femenino") {
															echo 'checked=""';
														}   ?> value="Femenino" >
					    				...
					    				<!--  SOLO LOS USUARIOS DE NIVEL 1 PUEDEN MODIFICAR -->
					    				<?php if($_SESSION['tipo_sbm']=="Administrador" && $_SESSION['privilegio_sbm']==1 && $campos['id']!=1): ?>
										<div class="col-xs-12 col-sm-6">
											<div class="form-group">
												<label class="control-label">Estado de la cuenta</label>
												<div class="radio radio-primary">
													<label>
														<input type="radio" name="optionsEstado-up"  <?php if ($campos['CuentaEstado']=="Activo") {
															echo 'checked=""';
														}   ?>  value="Activo" >
												...
												<div class="radio radio-primary">
													<label>
														<input type="radio" name="optionsEstado-up" <?php if ($campos['CuentaEstado']=="Deshabilitado") {
															echo 'checked=""';
														}   ?>  value="Deshabilitado"  >
							    	...
							    	<fieldset>
							    		...
							    		<p>
							    			Aqui puedes actualizar la contraseña actual. Procure que coincidan la nueva contraseña al momento de repetirlo.
							    		</p>
							    		<div class="container-fluid">
							    			<div class="row">
							    				<div class="col-xs-12 col-sm-6">
							    	...
							    	<br>
							    	<?php if($_SESSION['tipo_sbm']=="Administrador" && $_SESSION['privilegio_sbm']==1 && $campos['id']!=1 && $campos['CuentaTipo']=="Administrador" && $datos[1]=="admin" ):  ?>
							    	<fieldset>
							    		...
							    		<div class="container-fluid">
							    			<div class="row">
							    				...
							    				<div class="col-xs-12 col-sm-6">
													<div class="radio radio-primary">
														<label>
															<input type="radio" name="optionsPrivilegio-up" value="<?php echo $lc->encryption(1); ?>" <?php if ($campos['CuentaPrivilegio']==1) {
															echo 'checked=""';
														}   ?> >
													...
													<div class="radio radio-primary">
														<label>
															<input type="radio" name="optionsPrivilegio-up" value="<?php echo $lc->encryption(2); ?>" <?php if ($campos['CuentaPrivilegio']==2) {
															echo 'checked=""';
														}   ?>>
													...
													<div class="radio radio-primary">
														<label>
															<input type="radio" name="optionsPrivilegio-up" value="<?php echo $lc->encryption(3); ?>" <?php if ($campos['CuentaPrivilegio']==3) {
															echo 'checked=""';
														}   ?>>
				...
				?>
					<p>LA CUENTA SELECCIONADA NO EXISTE U_u</p>
				<?php
				}
			else:
		?>
