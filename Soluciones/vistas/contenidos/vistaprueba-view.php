...
<div class="container-fluid">
			<div class="page-header">
			  <h1 class="text-titles"><i class="zmdi zmdi-male-alt zmdi-hc-fw"></i> VISTA PRUEBA PARA CHITA <small>PACIENTES</small></h1>
			</div>
			<p class="lead">VISTA PRUEBA PARA CHITA</p>
		</div>
			...
			<ul class="breadcrumb breadcrumb-tabs">
			  	<li>
			  		<a href="<?php echo SERVERURL;?>paciente/" class="btn btn-info">
			  			<i class="zmdi zmdi-plus"></i> &nbsp; NUEVO VISTA
			  		</a>
			  	</li>
			  	<li>
